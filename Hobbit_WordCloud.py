...
mask = np.array(Image.open(r'C:\Users\Nick\Desktop\GitProjects\NLP_projects\The_Hobbit\dragon-silhouette.png'))

# Construct the wordcloud
wc = WordCloud(max_font_size=100, min_font_size=10, max_words=60, mask=mask, background_color='maroon', contour_width=2, contour_color='black').generate(text)
...
wc.to_file(r'C:\Users\Nick\Desktop\GitProjects\NLP_projects\The_Hobbit\Hobbit_wordcloud.png')
